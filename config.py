...
class SearchConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--controller_class', type=str,
                            default='models.search_cnn.SearchCNNController')
        ...
        parser.add_argument('--validate_split', type=float, default=0.5,
                            help='Split into train/test part (0 for run without validation part)')
        ...
        parser.add_argument('--quality', type=str, default='top1',
                            help='qualtiy criterion (top1 or negloss)')
        parser.add_argument('--use_train_quality', type=int,
                            default=0, help='use quality to early stop on train')
        parser.add_argument('--simple_alpha_update', type=int,
                            default=0, help='update alpha without unrolling')
